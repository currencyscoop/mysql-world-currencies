CREATE TABLE `currencies` (
  `Code` varchar(7) CHARACTER SET utf32 NOT NULL DEFAULT '',
  `Num` int(11) NOT NULL,
  `Ea` varchar(6) CHARACTER SET utf32 NOT NULL DEFAULT '',
  `Currency` varchar(58) CHARACTER SET utf32 NOT NULL DEFAULT '',
  `Locations_using_this_currency` varchar(665) CHARACTER SET utf32 DEFAULT NULL,
  PRIMARY KEY (`Code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_bin;


INSERT INTO `currencies` (`Code`, `Num`, `Ea`, `Currency`, `Locations_using_this_currency`)
VALUES
	...
	('AUD',36,'2','Australian dollar','Australia,  Christmas Island (CX),  Cocos (Keeling) Islands (CC),  Heard Island and McDonald Islands (HM),  Kiribati (KI),  Nauru (NR),  Norfolk Island (NF),  Tuvalu (TV)'),
	...
	('BMD',60,'2','Bermudian dollar','Bermuda'),
	('BND',96,'2','Brunei dollar','Brunei'),
	...
	('XTS',963,'.','Code reserved for testing',NULL),
